...
\author{Kenneth Vizcaíno Jiménez}
\date{1/7/2026}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{../outputs/comparacion_cence_modelo.pdf}
  \caption{Comparación CENCE real vs predicción del agente}
  \label{fig:comparacion_cence}
\end{figure}
